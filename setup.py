...
core = Extension(
    ...
    sources=[
        "ccmap/ccmapmodule.c",
        "ccmap/src/ccmapmodule_utils.c",
        "ccmap/src/ccmapmodule_allocation.c",
        "ccmap/src/decoygen.c",
        "ccmap/src/encode.c",
        "ccmap/src/molecular_object.c",
        "ccmap/src/pdb_coordinates.c",
        "ccmap/src/cell_crawler.c",
        "ccmap/src/mesh.c",
        "ccmap/src/transform_mesh.c",
        "ccmap/src/mesh_default.c",
        "ccmap/src/fibonacci.c",
        "ccmap/src/miscellaneous.c",
        "ccmap/src/sasa.c",
        "ccmap/src/atom_mapper.c",
        "ccmap/src/python_utils.c",
